...
class ThreadClient (threading.Thread):
    '''dérivation d'un objet thread pour gérer la cinnexion avec un client'''
...
while 1:
    ...
    print ("Client %s connecté adresse IP %s."%\
           (it,adresse[0], adresse[1]))
    # Dialogue avec le client :
    msg="Vous êtes connecté. Evoyer vos messages."
